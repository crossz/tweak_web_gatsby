              ...
              <Grid item xs={12} sm={8}>
                <Box className={classes.founderDetailWrapper}>
                  <Typography
                    ...
                    component='div'
                  >
                    <Box fontWeight='fontWeightBold'>背景及創辦人</Box>
                    ...
                    得易健康的工作團隊來自世界不同地方，團結於公司的使命，並日益壯大成長。對於公司未來發展方向，創始成員表示︰「能夠將世界一流學者的研究成果付諸民生應用、影響社會，我們深感自豪。我們有理想、有活力、有朝氣，致力成為醫療界別的開拓者，秉持積極創新、一絲不苟的理念和風格，勇於嘗試、突破傳統醫學科技的界限，努力為人類健康帶來切實、根本的改變。」
                  </Typography>
                </Box>
              </Grid>
            </Grid>
