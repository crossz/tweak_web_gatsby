        ...
        <Grid container spacing={0}>
          ...
          <Grid item xs={12} sm={6}>
            <Box height="100%" py={isMobile ? 5 : 6} borderBottom="1px solid #E1E1E1">
              ...
              <Box height={56}>
                <IconButton href={FACEBOOK_LINK} target="_blank" size="small" aria-label="facebook">
                  <FacebookIcon />
                </IconButton>
              </Box>
            </Box>
        ...
        {isMobile ? (
          <Box>
            ...
            >
              ...
              >
                <Typography className={classes.heading}>{t('t_and_c.terms_and_conditions')}</Typography>
              </AccordionSummary>
              <AccordionDetails
                classes={{
                  root: classes.accordDetails,
